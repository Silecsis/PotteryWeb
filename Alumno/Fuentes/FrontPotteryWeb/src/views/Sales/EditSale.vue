<!--
  Vista de edición de venta seleccionada.
  Muestra la venta de la api que se ha seleccionado.
  Solo puede acceder y realizar la edición el usuario de tipo admin. 
-->
<template>
  <div>
    <card-sin-logo>
...
export default {
  ...
  mounted() {
    Commons.loadForm(this,`sales`,"sale",'Ventas realizadas --> Editar venta');
  },
  methods: {
    save: function () {
       Commons.save(this,'edit',`sales`,this.sale,"La venta ha sido modificada correctamente",this.validate);
    },
    validate: function () {
