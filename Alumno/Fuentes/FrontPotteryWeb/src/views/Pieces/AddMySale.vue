...
<template>
  <div>
    <card-sin-logo>
      ...
      <div class="flex justify-center space-x-1">
        <h4>
          ¡Enhorabuena por haber realizado una nueva venta! Ahora solo falta
          registrar el precio y el nombre de la venta.
        </h4>
      </div>
...
export default {
  ...
  created() {
    this.$store.commit("SET_TITLE", "Mis piezas cerámicas -> Añadir venta");
  },
  data: function () {
    return {
      piece: {},
